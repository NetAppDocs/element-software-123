$(document).ready(function () {
  try {
    ...
    let zipLevel = "";
    let baseUrlSection = "/us-en/element-software-123/pdfs/sidebar/";
    let baseUrlPages = "/us-en/element-software-123/pdfs/pages/";
    let zipFilename = "";
    let zipFileSize = 0;
    zipLevel = zipLevel !== ""?zipLevel:1;
    zipFilename = zipFilename !== ''?zipFilename:"element-software-123.zip";
