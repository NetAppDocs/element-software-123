...
+
image::../media/element_new_ldap_servers.jpg[General settings for LDAP servers view]
...
. To create a user in this group so that anyone can log in, complete the following:
 .. Click *User* > *View*.
+
image::../media/element_new_cluster_admin.jpg[Create a new user view]
...
* link:concept_system_manage_manage_cluster_administrator_users.html#create-a-cluster-administrator-account[Create a cluster administrator account]
