...
NOTE: Software encryption at rest is available by default in all SolidFire Enterprise SDS nodes. Software encryption at rest provides a primary software layer of data security encryption in SolidFire Enterprise SDS nodes that do not include Self-Encrypting Drives (SEDs).
