...
@@ -77,21 +84,25 @@ The *Storage* tab lists the storage clusters that are part of your installation.
|Option
|Steps
...
a|
@@ -130,6 +141,9 @@ Here are the different states that the *Upgrade Status* column in the UI shows b
|Error
...
|===
@@ -139,6 +153,38 @@ Here are the different states that the *Upgrade Status* column in the UI shows b
...
@@ -165,6 +211,7 @@ https://<ManagementNodeIP>/package-repository/1/
