...
* *End User License Agreement (EULA)*: Beginning with management services .69, you must accept and save the EULA before using the NetApp Hybrid Cloud Control UI or API to upgrade storage firmware:
+
