...
@@ -109,7 +122,7 @@ Here are the different states that the *Upgrade Status* column in the UI shows b
...
@@ -143,6 +156,38 @@ CAUTION: Aborting the cluster upgrade while a node is being updated might result
...
@@ -168,6 +213,7 @@ https://<ManagementNodeIP>/package-repository/1/
